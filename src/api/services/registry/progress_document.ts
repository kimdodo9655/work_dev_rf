...
export const registryProgressDocumentAPI = {
  ...
  async getList(params: GetDocuments_2Params) {
    ...
    return apiHelpers.get(API.REGISTRY_PROGRESS_DOCUMENT.LIST(registryManagementNumber), query)
  },
  ...
  async save(params: SaveDocument_1Params) {
    ...
    return apiHelpers.post(API.REGISTRY_PROGRESS_DOCUMENT.SAVE(registryManagementNumber), data)
  },
  ...
  async download(query: DownloadDocument_2Query) {
    ...
    return apiHelpers.get(API.REGISTRY_PROGRESS_DOCUMENT.DOWNLOAD(registryManagementNumber), params)
  },
