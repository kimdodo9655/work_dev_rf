...
export const registryCompletionAPI = {
  async getList(params: GetCompleteDocumentsParams) {
    ...
    return apiHelpers.get(API.REGISTRY_COMPLETION.LIST(registryManagementNumber), query)
  },
  ...
  async getDetail(params: GetDetailedCompleteDocumentsParams) {
    ...
    // --------------------------------------------------
    const { registryManagementNumber, ...query } = params as any
    return apiHelpers.get(API.REGISTRY_COMPLETION.DETAIL(registryManagementNumber), query)
  },
  ...
  async previewBase64(query: ViewCompleteDocumentQuery) {
    ...
    return apiHelpers.get(API.REGISTRY_COMPLETION.PREVIEW_BASE64(registryManagementNumber), params)
  },
