...
export const registryTestAPI = {
  async createRequest(_query: CreateRegistryRequestTestDataQuery) {
    ...
    // --------------------------------------------------
    return apiHelpers.post(API.REGISTRY_TEST.CREATE_REQUEST)
  },
  ...
  async createProgress(_query: CreateRegistryProgressTestDataQuery) {
    ...
    // --------------------------------------------------
    return apiHelpers.post(API.REGISTRY_TEST.CREATE_PROGRESS)
  },
  ...
  async createCombine(_query: CreateRegistryTypeComboTestDataQuery) {
    // --------------------------------------------------
    // [R00-06][POST - /api/registry/test-data/combine] 진행 유형별 등기 의뢰+진행 테스트 데이터 생성
    // --------------------------------------------------
    return apiHelpers.post(API.REGISTRY_TEST.CREATE_COMBINE)
  }
}
