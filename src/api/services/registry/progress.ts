...
export const registryProgressAPI = {
  async getList(query: SearchRegistryProgresssListQuery) {
    ...
    // --------------------------------------------------
    return apiHelpers.get(API.REGISTRY_PROGRESS.LIST, query)
  },
  ...
  async basicInfo(params: GetRegistryProgressBasicInfoParams) {
    ...
    return apiHelpers.get(API.REGISTRY_PROGRESS.BASIC_INFO(registryManagementNumber), query)
  },
  ...
  async assignManager(params: PatchRegistryProgressAssignManagerParams) {
    ...
    return apiHelpers.patch(API.REGISTRY_PROGRESS.ASSIGN_MANAGER(registryManagementNumber), data)
  },
  ...
  async loanInfo(params: GetRegistryProgressLoanInfoParams) {
    ...
    // --------------------------------------------------
    const { registryManagementNumber, ...query } = params as any
    return apiHelpers.get(API.REGISTRY_PROGRESS.LOAN_INFO(registryManagementNumber), query)
  },
  ...
  async ownershipTransfer(params: GetRegistryProgressOwnershipTransferParams) {
    ...
    // --------------------------------------------------
    const { registryManagementNumber, ...query } = params as any
    return apiHelpers.get(API.REGISTRY_PROGRESS.OWNERSHIP_TRANSFER(registryManagementNumber), query)
  },
  ...
  async mortgage(params: GetRegistryProgressMortgageParams) {
    ...
    // --------------------------------------------------
    const { registryManagementNumber, ...query } = params as any
    return apiHelpers.get(API.REGISTRY_PROGRESS.MORTGAGE(registryManagementNumber), query)
  },
  ...
  async legalAgent(query: GetRegistryProgressLegalAgentQuery) {
    ...
    return apiHelpers.get(API.REGISTRY_PROGRESS.LEGAL_AGENT(registryManagementNumber), params)
  },
  ...
  async process(params: GetRegistryProgressProcessParams) {
    ...
    // --------------------------------------------------
    const { registryManagementNumber, ...query } = params as any
    return apiHelpers.get(API.REGISTRY_PROGRESS.PROCESS(registryManagementNumber), query)
  },

  async changeProcess(params: ChangeRegistryProgressProcessParams) {
    // --------------------------------------------------
    // [R02B-09][PATCH - /api/registry/progress/{registryManagementNumber}/process/change] 등기진행 상태 변경
    // --------------------------------------------------
    const { registryManagementNumber, ...data } = params as any
    return apiHelpers.patch(API.REGISTRY_PROGRESS.CHANGE_PROCESS(registryManagementNumber), data)
  }
}
