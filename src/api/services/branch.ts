...
export const branchAPI = {
  async search(query: SearchBranchesQuery) {
    ...
    // --------------------------------------------------
    return apiHelpers.get(API.BRANCH.SEARCH, query)
  },
  ...
  async getDetail(params: GetBranchParams) {
    ...
    // --------------------------------------------------
    return apiHelpers.get(API.BRANCH.DETAIL(params.branchId))
  },

  async update(params: UpdateBranchParams) {
    // --------------------------------------------------
    // [P02A-03][PATCH - /api/branches/{branchId}] 지점 수정
    // --------------------------------------------------
    return apiHelpers.patch(API.BRANCH.UPDATE(params.branchId))
  },
  ...
  async getOptions(query: GetBranchOptionsQuery) {
    ...
    // --------------------------------------------------
    return apiHelpers.get(API.BRANCH.OPTIONS, query)
  },
  ...
  async checkBusinessNumber(query: CheckBusinessNumberQuery) {
    ...
    // --------------------------------------------------
    return apiHelpers.get(API.BRANCH.CHECK_BUSINESS_NUMBER, query)
  }
}
